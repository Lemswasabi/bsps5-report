...
\end{lstlisting}
where \textit{\$config\_file} is the file defining the model's hyperparameters, \textit{\$log\_dir} is the directory name for logging the tensorboard data and \textit{\$model\_name} is the name under which a checkpoint of the model is made.\\
