...
In this section, we present \sout{our} program which extracts the Mel-filterbank features from the LibriSpeech dataset. \sout{Although, this program should not be used if end-to-end ASR is desired.} The program executes the following steps:
