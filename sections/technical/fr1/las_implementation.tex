...
The following listing showcases the \textit{set\_model()} method, which initialises the \textit{Adadelta} optimizer, creates an \textit{ASR()} instance for the \textit{self.model} attribute and assigns the \textit{CrossEntropyLoss} as the loss function.
