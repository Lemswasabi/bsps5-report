...
% In this section, the performance of the four ANNs investigated in Section~\ref{ann} are evaluated. We use the English and Luxembourgish dataset for the performance analysis.\\

For this study, we use 460h of the roughly 1000h LibriSpeech audio corpus which contains read English speech. It contains 132553 examples of varying lengths, sampled at $16kHz$ and saved as FLAC formated file. This dataset represents 772 speakers reading the different sentences. The data is gathered from read audiobooks from the LibriVox project. Addionally, these readings were segmented and aligned into example sentences.\cite{panayotov2015librispeech}
