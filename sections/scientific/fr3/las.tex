...
This learning framework has been applied to many domains, such as machine translations, image captioning, etc. This learning process is not limited to a particular domain and it could be applied to build ASR systems.
