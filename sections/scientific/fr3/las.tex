...
\end{align}
%
where $\phi$ and $\psi$ are MLP networks and $c_i$ can be interpreted as a collection of weighted features of h. Fig. \ref{las_model} illustrates the operation $AttendAndSpell$.
