...
%   \item Feedforward:
    \begin{figure}[H]
      \centering
      \subfloat[Feedforward's accuracy using SGD.]{{\includegraphics[scale=0.5]{sgdffa.png} }}%
      \qquad
      \subfloat[Feedforward's accuracy using Adam.]{{\includegraphics[scale=0.5]{adamffa.png} }}%
      \caption{Accuracy comparison between feedforward using SGD and Adam.}%
      \label{ffa}
    \end{figure}
    \begin{figure}[H]
      \centering
      \subfloat[Feedforward's loss using SGD.]{{\includegraphics[scale=0.5]{sgdffl.png} }}%
      \qquad
      \subfloat[Feedforward's loss using Adam.]{{\includegraphics[scale=0.5]{adamffl.png} }}%
